...
internal class DeleteViewOperationTests : Tests
{
    ...
    public void TestDeletingObjectWithDependency_IsImpossible()
    {
        ...
        ClassicAssert.IsFalse(new DeleteViewOperation(Mock.Of<IApplication>(), (Design)lbl1.Data).IsImpossible);
        ClassicAssert.IsFalse(new DeleteViewOperation(Mock.Of<IApplication>(), (Design)lbl2.Data).IsImpossible);

        // we now have a dependency of lbl2 on lbl1 so deleting lbl1 will go badly
        lbl2.X = Pos.Right(lbl1) + 5;

        ClassicAssert.IsTrue(new DeleteViewOperation(Mock.Of<IApplication>(), (Design)lbl1.Data).IsImpossible);
    }
    ...
    public void TestDeletingObjectWithDependency_IsAllowedIfDeletingBoth()
    {
        ...
        ClassicAssert.IsFalse(new DeleteViewOperation(Mock.Of<IApplication>(), (Design)lbl1.Data, (Design)lbl2.Data).IsImpossible);
        ClassicAssert.IsFalse(new DeleteViewOperation(Mock.Of<IApplication>(), (Design)lbl2.Data, (Design)lbl1.Data).IsImpossible);

        ClassicAssert.AreEqual(3, designOut.GetAllDesigns().Count());
        var cmd = new DeleteViewOperation(Mock.Of<IApplication>(), (Design)lbl2.Data, (Design)lbl1.Data);
    ...
    public void TestDeleting_ClearsSelection(bool lockSelection)
    {
        ...
        ClassicAssert.IsFalse(new DeleteViewOperation(Mock.Of<IApplication>(), lbl1Design).IsImpossible);

        ClassicAssert.AreEqual(2, designOut.GetAllDesigns().Count());
        var cmd = new DeleteViewOperation(Mock.Of<IApplication>(), lbl1Design);
    ...
    public void TestPreventDeleting_PopulatedWhenDependenciesExist()
    {
        ...
        var cmd = new DeleteViewOperation(Mock.Of<IApplication>(), (Design)lbl1.Data);
