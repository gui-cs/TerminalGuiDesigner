...
public partial class DragOperation : Operation
{
    ...
    private Point OffsetByDropInto(DragMemento mem, Point p)
    {
        ...
        mem.OriginalSuperView.ViewToScreenActual(0, 0, out var originalSuperX, out var originalSuperY, false);
        this.DropInto.ViewToScreenActual(0, 0, out var newSuperX, out var newSuperY, false);
